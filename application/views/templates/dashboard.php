...
<head>
    ...
    <link rel="icon" type="image/png" href="assets/img/unnamed.png"/>
    <title><?= $title; ?> | Aplikasi Data Vaksin</title>
        ...
        <ul class="navbar-nav bg-white sidebar sidebar-light accordion shadow-sm" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex text-white align-items-center bg-primary justify-content-center" href="<?= base_url('dashboard'); ?>">
                ...
                <div class="sidebar-brand-icon">
                  ...
                  <i aria-hidden="true"><img src="<?= base_url(); ?>assets/img/logovaksin.png" width="50"></i>
                </div>
            ...
            <li class="nav-item">
                <a class="nav-link pb-0" href="<?= base_url('profile/setting'); ?>">
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url('gudang'); ?>">
                    <i class="fas fa-fw fa-folder"></i>
                    <span><b>Data Jadwal Vaksin</b></span>
                </a>
            </li>
            ...
            <footer class="sticky-footer bg-light">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>&copy;2021 Data Vaksin All rights reserved <?= anchor('https://shopee.co.id/giftech', '| Websites For Inventory - by Gilang Faisal'); ?></span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
