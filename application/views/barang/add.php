            ...
            <div class="card-body">
               ...
               <?php echo form_open_multipart('Barang/add');?>
                <div class="row form-group">
                    <label class="col-md-3 text-md-right" for="id_barang">Kode SKU</label>
                    <div class="col-md-9">
                        <input value="<?= set_value('id_barang', $id_barang); ?>" name="id_barang" id="id_barang" type="text" class="form-control" placeholder="Kode Sku...">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            <select name="supplier_id" id="supplier_id" class="custom-select">
                                ...
                                <?php foreach ($supplier as $g) : ?>
                                    <option <?= set_select('supplier_id', $g['id_supplier']) ?> value="<?= $g['id_supplier'] ?>"><?= $g['supplier'] ?></option>
                                <?php endforeach; ?>
                            </select>
                            <div class="input-group-append">
