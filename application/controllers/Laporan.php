...
class Laporan extends CI_Controller
{
    ...
    private function _cetak($data, $table_, $tanggal)
    {
        ...
        $table = $table_ == 'barang_masuk' ? 'Barang Masuk' : 'Data Pasien';

        $pdf = new FPDF();
        $pdf->AddPage('L', 'Letter');
        $pdf->SetFont('Times', 'B', 16);
        $pdf->Image('./assets/img/logovaksin.png',10,8,17,15);
        $pdf->Image('./assets/img/logovaksin.png',255,8,15,14);
        ...
        if ($table_ == 'barang_masuk') :
            ...
            $pdf->Ln(60);
                $pdf->Cell(75);
                $pdf->Cell(270,7,'Tasikmalaya, '.date('d-m-y'),0,1,'C');
                $pdf->Cell(75);
                $pdf->Cell(270,7,'Kepala Gudang,',0,1,'C');    
                $pdf->Ln(20);
                $pdf->Cell(75);
                $pdf->SetFont('Times','B',15);
                $pdf->Cell(270,7,'Gilang Faisal',0,1,'C');
